...
export default function Navbar({ isDarkMode, setIsDarkMode }) {
  ...
  const isLetsTalkActive =
    location.pathname === "/" || location.hash === "#ai-chat";
    ...
    <>
      <nav className="fixed top-0 left-0 w-full h-20 bg-[var(--color-navbar)] shadow-lg px-6 md:px-12 lg:px-24 flex items-center justify-between z-50 transition-colors duration-700">
        ...
        <Link
          ...
          className="uppercase text-xl font-semibold tracking-wide text-[var(--color-text-active)] z-50 select-none"
        >
          {domain}
        </Link>
        ...
        <div className="hidden md:flex items-center text-lg gap-10">
          ...
          <Button link={"https://www.linkedin.com/in/sadampayodasabilillah"}>
            Hubungkan
          </Button>
        </div>
